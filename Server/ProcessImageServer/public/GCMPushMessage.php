...
/*
	...
	@author Matt Grundy
	@author Kenneth V Kennedy (Added topic messaging capabilities.)
...
class GCMPushMessage {
	...
	*/
	function GCMPushMessage($apiKeyIn = "AIzaSyBj-HySaJ5ndIJ6pchXs87zMF7kGqX2PtY"){
	...
	*/
	function send($message, $data = false) {
		...
		if(strcmp(substr($this->devices[0],0,8),"/topics/")==0) {
			$fields = array(
				'to'     => $this->devices[0],
